...
public static class Helper
{
    ...
    static Helper()
    {
        ...
        DataSource = new NpgsqlDataSourceBuilder(Utilities.FormatConnectionString(conn)).Build();
    ...
    {
        //read and combine all files from ../sql/
        var sql = @"
DROP SCHEMA IF EXISTS climate_ctrl CASCADE;
