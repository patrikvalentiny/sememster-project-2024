...
public class ControllersUnitTests
{
    ...
    public void GetDevicesTest()
    {
        ...
        var controller = new DeviceController(deviceService.Object);
    ...
    public void GetDevicesTestThrows404()
    {
        ...
        var controller = new DeviceController(dataService.Object);
        var result = controller.GetDevices();
    ...
    public void GetDeviceConfigTest()
    {
        ...
        deviceService.Setup(x => x.GetDeviceConfig(It.IsAny<string>())).Returns(data);
    ...
    {
        var deviceService = new Mock<IDeviceService>();
        deviceService.Setup(x => x.GetDeviceConfig(It.IsAny<string>())).Throws(new Exception());
    ...
    public void GetMotorPositionTest()
    {
        ...
        var controller = new MotorController(motorService.Object);
